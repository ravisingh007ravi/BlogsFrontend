    ...
    return (
        <Components>
            <Box>
                ...
                <Wrapper>
                    <TextField type="text" name='name' onChange={ChangeSignUpData} label="Enter Name" variant="standard" />
                    <TextField type="text" name='userName' onChange={ChangeSignUpData} label="Enter EmailId" variant="standard" />
